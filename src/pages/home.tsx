...
const Home = () => {
    return (
        <>
            <motion.div initial={{ opacity: -2, y: 0 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 2}} className="flex flex-col gap-10 items-center md:w-[90%] mx-auto lg:flex-row mb-12 md:my-20">
